    ...
    <form action="" method="post" class="mb-3" style="width: 400px;">
      ...
      <fieldset class="mb-3">
        <?php if (isset($value)) {?>
            ...
            <input id="nome" name="nome" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['nome']?>"  >

            <label for="endereco" class="form-label">Endereço</label>
            <input id="endereco" name="endereco" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['endereco']?>"  >

            <label for="telefone" class="form-label">Telefone</label>
            <input id="telefone" name="telefone" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['telefone']?>"  >

            <label for="cpf" class="form-label">CPF</label>
            <input id="cpf" name="cpf" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['cpf']?>"  >

            <label for="codDepartamento" class="form-label">Departamento (Departamento atual: <?php echo $value[0]['nomeDepartamento'] ?>)</label>
            ...
            <label for="codCargo" class="form-label">Cargo (Cargo atual: <?php echo $value[0]['nomeCargo'] ?>)</label>
