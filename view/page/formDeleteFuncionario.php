    ...
    <form action="" method="post" class="mb-3" style="width: 400px;">
      ...
      <fieldset class="mb-3">
        <?php if (isset($value)) {?>
            ...
            <input id="nome" name="nome" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['nome']?>"  readonly>

            <label for="endereco" class="form-label">Endereço</label>
            <input id="endereco" name="endereco" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['endereco']?>"  readonly>

            <label for="funcional" class="form-label">Funcional</label>
            <input id="funcional" name="funcional" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['funcional']?>"  readonly>

            <label for="cpf" class="form-label">CPF</label>
            <input id="cpf" name="cpf" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['cpf']?>"  readonly>

            <label for="nomeDepartamento" class="form-label">Departamento</label>
            <input id="nomeDepartamento" name="nomeDepartamento" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['nomeDepartamento']?>"  readonly>

            <label for="nomeCargo" class="form-label">Cargo</label>
            <input id="nomeCargo" name="nomeCargo" type="text" class="form-control" maxlength="50" value="<?php echo $value[0]['nomeCargo']?>"  readonly>
        <?php } ?>
      </fieldset>
